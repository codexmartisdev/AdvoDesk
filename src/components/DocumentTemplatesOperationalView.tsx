          ...
          <div className="bg-white w-full max-w-3xl rounded-3xl border border-slate-200 shadow-2xl max-h-[92vh] overflow-y-auto p-6">
            ...
            <form onSubmit={saveTemplate} className="space-y-4">
              ...
              <div>
                ...
                <textarea value={formContentPattern} onChange={(event) => { setFormContentPattern(event.target.value); setFormError(''); }} rows={16} className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 border border-slate-200 font-mono text-xs leading-relaxed" placeholder="Use variáveis como {CLIENTE_NOME}, {CASO_PROCESSO}, {BPC_DER}..." />
