        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs space-y-3">
          ...
          <ul className="text-xs text-slate-600 space-y-2">
            <li className="flex items-start gap-2">
              ...
              <span>Laudo médico circunstanciado com CID-10 e data de início do impedimento</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="material-symbols-outlined text-emerald-600 text-sm mt-0.5">check</span>
              <span>Exames complementares, audiometrias, laudos neurológicos ou psiquiátricos</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="material-symbols-outlined text-emerald-600 text-sm mt-0.5">check</span>
              <span>Receituários contínuos e prontuário de atendimento da rede pública/SUS</span>
            </li>
          </ul>
        </div>

        {/* Pilar 2: Avaliação Social */}
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs space-y-3">
          <div className="flex items-center gap-3 pb-3 border-b border-slate-100">
          ...
          <ul className="text-xs text-slate-600 space-y-2">
            <li className="flex items-start gap-2">
              <span className="material-symbols-outlined text-emerald-600 text-sm mt-0.5">check</span>
              <span>Comprovação de acessibilidade, dependência de terceiros para atos da vida civil</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="material-symbols-outlined text-emerald-600 text-sm mt-0.5">check</span>
              <span>Barreiras atitudinais, urbanísticas, de transporte e comunicação</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="material-symbols-outlined text-emerald-600 text-sm mt-0.5">check</span>
              <span>Gastos elevados com fraldas, medicamentos não fornecidos pelo SUS e alimentação especial</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-xs p-5">
        ...
        {pcdCases.length === 0 ? (
          <p className="text-xs text-slate-500 py-3 text-center">
            Nenhum caso BPC de Pessoa com Deficiência cadastrado no momento.
          </p>
        ) : (
